...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chiropractornearme.in/sciatica-treatment-hyderabad",
  },
  openGraph: {
    title: "Sciatica Treatment in Hyderabad | Permanent Sciatic Nerve Relief",
    description: "Looking for sciatica treatment in Hyderabad? Our expert chiropractic adjustments relieve sciatic nerve compression instantly.",
    url: "https://www.chiropractornearme.in/sciatica-treatment-hyderabad",
...
export default function ServicePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "name": "Sciatica Treatment in Hyderabad | Permanent Sciatic Nerve Relief",
        "description": "Looking for sciatica treatment in Hyderabad? Our expert chiropractic adjustments relieve sciatic nerve compression instantly.",
        "url": "https://www.chiropractornearme.in/sciatica-treatment-hyderabad",
        "about": {
          "@type": "MedicalCondition",
          "name": "Non-Surgical Sciatica Treatment in Hyderabad"
        }
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Non-Surgical Sciatica Treatment in Hyderabad",
            "item": "https://www.chiropractornearme.in/sciatica-treatment-hyderabad"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How long does sciatica take to heal?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "With targeted chiropractic care, many patients experience a 50-80% reduction in pain within the first few weeks of treatment."
            }
          },
          {
            "@type": "Question",
            "name": "Can a slipped disc cause sciatica?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, a herniated or slipped disc in the lower back is one of the most common causes of sciatic nerve compression."
            }
          }
        ]
      }
    ...
    <main className="flex min-h-screen flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-slate-900 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6">
            Non-Surgical Sciatica Treatment in Hyderabad
          </h1>
      ...
      <div className="bg-white border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-800 font-medium">Non-Surgical Sciatica Treatment in Hyderabad</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="prose prose-lg prose-slate max-w-none mb-10">
              <p className="text-slate-600 leading-relaxed text-lg">Sciatica causes sharp, shooting pain down your leg. It’s often caused by a herniated disc or spinal misalignment compressing the sciatic nerve. Our targeted spinal adjustments relieve this pressure, providing fast, effective, and permanent relief from sciatic nerve pain without surgical intervention.</p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">How long does sciatica take to heal?</h3>
                  <p className="text-slate-600 leading-relaxed">With targeted chiropractic care, many patients experience a 50-80% reduction in pain within the first few weeks of treatment.</p>
                </div>
                
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Can a slipped disc cause sciatica?</h3>
                  <p className="text-slate-600 leading-relaxed">Yes, a herniated or slipped disc in the lower back is one of the most common causes of sciatic nerve compression.</p>
                </div>
