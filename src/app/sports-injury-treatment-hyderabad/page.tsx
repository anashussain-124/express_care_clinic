...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chiropractornearme.in/sports-injury-treatment-hyderabad",
  },
  openGraph: {
    title: "Sports Injury Treatment in Hyderabad | Athletic Recovery",
    description: "Recover faster with specialized sports injury treatment in Hyderabad. Chiropractic care for athletes and active individuals.",
    url: "https://www.chiropractornearme.in/sports-injury-treatment-hyderabad",
...
export default function ServicePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "name": "Sports Injury Treatment in Hyderabad | Athletic Recovery",
        "description": "Recover faster with specialized sports injury treatment in Hyderabad. Chiropractic care for athletes and active individuals.",
        "url": "https://www.chiropractornearme.in/sports-injury-treatment-hyderabad",
        "about": {
          "@type": "MedicalCondition",
          "name": "Specialized Sports Injury Treatment in Hyderabad"
        }
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Specialized Sports Injury Treatment in Hyderabad",
            "item": "https://www.chiropractornearme.in/sports-injury-treatment-hyderabad"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Do chiropractors treat muscle strains?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, we use soft tissue therapies alongside joint adjustments to promote rapid healing of muscle strains and ligament sprains."
            }
          },
          {
            "@type": "Question",
            "name": "Can chiropractic improve athletic performance?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutely. Proper spinal alignment improves nervous system function, biomechanics, and flexibility, which directly enhances athletic performance."
            }
          }
        ]
      }
    ...
    <main className="flex min-h-screen flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-slate-900 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6">
            Specialized Sports Injury Treatment in Hyderabad
          </h1>
      ...
      <div className="bg-white border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-800 font-medium">Specialized Sports Injury Treatment in Hyderabad</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="prose prose-lg prose-slate max-w-none mb-10">
              <p className="text-slate-600 leading-relaxed text-lg">Whether you’re a professional athlete or a weekend warrior, sports injuries require specialized care to ensure a full and rapid recovery. We treat sprains, strains, tendonitis, and joint dysfunctions using sports chiropractic techniques, enabling you to return to your peak performance faster and stronger.</p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Do chiropractors treat muscle strains?</h3>
                  <p className="text-slate-600 leading-relaxed">Yes, we use soft tissue therapies alongside joint adjustments to promote rapid healing of muscle strains and ligament sprains.</p>
                </div>
                
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Can chiropractic improve athletic performance?</h3>
                  <p className="text-slate-600 leading-relaxed">Absolutely. Proper spinal alignment improves nervous system function, biomechanics, and flexibility, which directly enhances athletic performance.</p>
                </div>
