...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chiropractornearme.in/back-pain-treatment-hyderabad",
  },
  openGraph: {
    title: "Best Back Pain Treatment in Hyderabad | Express Care Clinic",
    description: "Get permanent relief with the best back pain treatment in Hyderabad. We offer non-surgical spinal adjustments to cure lower and upper back pain.",
    url: "https://www.chiropractornearme.in/back-pain-treatment-hyderabad",
...
export default function ServicePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "name": "Best Back Pain Treatment in Hyderabad | Express Care Clinic",
        "description": "Get permanent relief with the best back pain treatment in Hyderabad. We offer non-surgical spinal adjustments to cure lower and upper back pain.",
        "url": "https://www.chiropractornearme.in/back-pain-treatment-hyderabad",
        "about": {
          "@type": "MedicalCondition",
          "name": "Advanced Back Pain Treatment in Hyderabad"
        }
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Advanced Back Pain Treatment in Hyderabad",
            "item": "https://www.chiropractornearme.in/back-pain-treatment-hyderabad"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How is back pain diagnosed?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We perform a comprehensive physical and neurological examination, and may use imaging like X-rays or MRIs if necessary to pinpoint the exact cause."
            }
          },
          {
            "@type": "Question",
            "name": "How many sessions do I need for back pain?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Many patients feel significant relief after the first session, though a complete treatment plan typically involves multiple sessions depending on severity."
            }
          }
        ]
      }
    ...
    <main className="flex min-h-screen flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-slate-900 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6">
            Advanced Back Pain Treatment in Hyderabad
          </h1>
      ...
      <div className="bg-white border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-800 font-medium">Advanced Back Pain Treatment in Hyderabad</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="prose prose-lg prose-slate max-w-none mb-10">
              <p className="text-slate-600 leading-relaxed text-lg">Back pain can severely limit your daily life. At Express Care Clinic, we specialize in identifying the root cause of your back pain—whether it’s poor posture, a herniated disc, or muscle strain. Our customized chiropractic adjustments provide immediate and long-lasting relief without the need for medication or invasive surgery.</p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">How is back pain diagnosed?</h3>
                  <p className="text-slate-600 leading-relaxed">We perform a comprehensive physical and neurological examination, and may use imaging like X-rays or MRIs if necessary to pinpoint the exact cause.</p>
                </div>
                
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">How many sessions do I need for back pain?</h3>
                  <p className="text-slate-600 leading-relaxed">Many patients feel significant relief after the first session, though a complete treatment plan typically involves multiple sessions depending on severity.</p>
                </div>
