...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chiropractornearme.in/frozen-shoulder-treatment-hyderabad",
  },
  openGraph: {
    title: "Frozen Shoulder Treatment in Hyderabad | Fast Recovery",
    description: "Get back your mobility with expert frozen shoulder treatment in Hyderabad. Express Care Clinic offers advanced mobilization techniques.",
    url: "https://www.chiropractornearme.in/frozen-shoulder-treatment-hyderabad",
...
export default function ServicePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "name": "Frozen Shoulder Treatment in Hyderabad | Fast Recovery",
        "description": "Get back your mobility with expert frozen shoulder treatment in Hyderabad. Express Care Clinic offers advanced mobilization techniques.",
        "url": "https://www.chiropractornearme.in/frozen-shoulder-treatment-hyderabad",
        "about": {
          "@type": "MedicalCondition",
          "name": "Expert Frozen Shoulder Treatment in Hyderabad"
        }
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Expert Frozen Shoulder Treatment in Hyderabad",
            "item": "https://www.chiropractornearme.in/frozen-shoulder-treatment-hyderabad"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What triggers a frozen shoulder?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "It often occurs after an injury, surgery, or prolonged immobility, though it can also develop gradually without a specific cause."
            }
          },
          {
            "@type": "Question",
            "name": "Can chiropractic treat frozen shoulder?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutely. We use specific mobilization techniques that target the shoulder capsule to improve mobility and decrease pain."
            }
          }
        ]
      }
    ...
    <main className="flex min-h-screen flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-slate-900 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6">
            Expert Frozen Shoulder Treatment in Hyderabad
          </h1>
      ...
      <div className="bg-white border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-800 font-medium">Expert Frozen Shoulder Treatment in Hyderabad</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="prose prose-lg prose-slate max-w-none mb-10">
              <p className="text-slate-600 leading-relaxed text-lg">Adhesive capsulitis, commonly known as frozen shoulder, causes severe stiffness and pain. Our multi-modal approach includes joint mobilization, soft tissue therapy, and chiropractic adjustments to break down scar tissue and restore your shoulder’s full range of motion quickly and safely.</p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">What triggers a frozen shoulder?</h3>
                  <p className="text-slate-600 leading-relaxed">It often occurs after an injury, surgery, or prolonged immobility, though it can also develop gradually without a specific cause.</p>
                </div>
                
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Can chiropractic treat frozen shoulder?</h3>
                  <p className="text-slate-600 leading-relaxed">Absolutely. We use specific mobilization techniques that target the shoulder capsule to improve mobility and decrease pain.</p>
                </div>
