...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chiropractornearme.in/slipped-disc-treatment-hyderabad",
  },
  openGraph: {
    title: "Slipped Disc Treatment in Hyderabad | Herniated Disc Relief",
    description: "Avoid surgery with our non-invasive slipped disc treatment in Hyderabad. Safe, effective chiropractic care for herniated discs.",
    url: "https://www.chiropractornearme.in/slipped-disc-treatment-hyderabad",
...
export default function ServicePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "name": "Slipped Disc Treatment in Hyderabad | Herniated Disc Relief",
        "description": "Avoid surgery with our non-invasive slipped disc treatment in Hyderabad. Safe, effective chiropractic care for herniated discs.",
        "url": "https://www.chiropractornearme.in/slipped-disc-treatment-hyderabad",
        "about": {
          "@type": "MedicalCondition",
          "name": "Non-Invasive Slipped Disc Treatment in Hyderabad"
        }
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Non-Invasive Slipped Disc Treatment in Hyderabad",
            "item": "https://www.chiropractornearme.in/slipped-disc-treatment-hyderabad"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, the vast majority of herniated discs heal effectively with conservative therapies like chiropractic care and physical rehabilitation."
            }
          },
          {
            "@type": "Question",
            "name": "What are the symptoms of a slipped disc?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Symptoms include localized back pain, numbness, tingling, and sharp radiating pain down the arms or legs depending on the location."
            }
          }
        ]
      }
    ...
    <main className="flex min-h-screen flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-slate-900 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6">
            Non-Invasive Slipped Disc Treatment in Hyderabad
          </h1>
      ...
      <div className="bg-white border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-800 font-medium">Non-Invasive Slipped Disc Treatment in Hyderabad</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="prose prose-lg prose-slate max-w-none mb-10">
              <p className="text-slate-600 leading-relaxed text-lg">A slipped or herniated disc can cause agonizing back and nerve pain. Before considering spine surgery, explore our conservative chiropractic care. We utilize spinal decompression techniques and gentle adjustments to relieve disc pressure, allowing the herniation to heal naturally and alleviating nerve pain.</p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Can a slipped disc heal without surgery?</h3>
                  <p className="text-slate-600 leading-relaxed">Yes, the vast majority of herniated discs heal effectively with conservative therapies like chiropractic care and physical rehabilitation.</p>
                </div>
                
                <div className="border-b border-slate-100 pb-6">
                  <h3 className="text-xl font-bold text-slate-800 mb-3">What are the symptoms of a slipped disc?</h3>
                  <p className="text-slate-600 leading-relaxed">Symptoms include localized back pain, numbness, tingling, and sharp radiating pain down the arms or legs depending on the location.</p>
                </div>
