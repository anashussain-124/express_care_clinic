...
const conditions: Condition[] = [
  {
    ...
    icon: Activity,
    // Physiotherapist working on patient's lower back
  ...
  },
  {
    ...
    icon: PersonStanding,
    // Person holding neck in pain at desk
  ...
  },
  {
    ...
    icon: Zap,
    // Person with lower back and leg pain
  ...
  },
  {
    ...
    icon: Bone,
    // Spinal anatomy / vertebrae model
  ...
  },
  {
    ...
    icon: HeartPulse,
    // Physiotherapist treating patient's shoulder
  ...
  },
  {
    ...
    icon: Waves,
    // Spine X-ray or posture assessment
  ...
  },
  {
    ...
    icon: Wind,
    // Person with sinus/facial pressure
  ...
  },
  {
    ...
    icon: Flame,
    // Person breathing deeply / lungs wellness
  ...
  },
  {
    ...
    icon: Brain,
    // Person holding head in migraine pain
  ...
  },
  {
    ...
    icon: Droplets,
    // Person with stomach / digestive discomfort
  ...
  },
  {
    ...
    icon: Stethoscope,
    // Doctor examining patient's leg / vascular care
            ...
            >
              ...
              <div className="relative h-56 sm:h-72 w-full overflow-hidden rounded-t-3xl">
                ...
                <img
                  ...
                  onError={(e) => {
                    // Fallback to a generic medical image if the specific one fails
